...
server_socket.bind(('0.0.0.0', 5555))  # 任意のIPアドレスで受け付け
server_socket.listen(1)  # 1台のクライアントを受け入れる
...
pygame.display.set_caption("Pong Game - Server")
...
def receive_input():
    ...
    while True:
        try:
            ...
            if data == 'UP' and player2_y > 0:
                player2_y -= PADDLE_SPEED
            elif data == 'DOWN' and player2_y < SCREEN_HEIGHT - PADDLE_HEIGHT:
                player2_y += PADDLE_SPEED
        except:
            break
